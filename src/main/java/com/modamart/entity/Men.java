...
public class Men {
    ...
    public Men(int id, String title, String category, String subCategory, int price, String size, String color, String pattern, String occasion, String embellishment, String imageName) {
        this.id = id;
        this.title = title;
